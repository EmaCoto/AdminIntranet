        ...
        @forelse ($users as $user)
            <ul class="user-item h-48 rounded-lg hover:shadow-xl hover:bg-gray-400 m-1 flex flex-col justify-between p-2">
                ...
                <div class="h-full items-end border-t-2">
                    ...
                    <button wire:click.prevent="confirmDeletion({{ $user->ID }})" class="group relative flex p-1 w-full flex-col items-center justify-center overflow-hidden rounded-b-lg bg-[#B33031] hover:bg-red-600">
                      ...
                      <svg
                        width="16" fill="none" viewBox="0 0 39 7" class="origin-right duration-500 group-hover:opacity-0">
