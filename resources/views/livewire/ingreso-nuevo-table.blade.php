<div class="p-10">
                ...
                @forelse ($ingresos as $ingreso)
                    <tr class="hover:bg-gray-100 text-center text-sm">
                        ...
                        <td class="p-1 py-2 text-center">
                            ...
                            <!-- Botón para eliminar -->
                            <button wire:click="delete({{ $ingreso->id }})" class="bg-[#B23B3B] hover:bg-red-700 text-white px-4 py-2 rounded-md ml-2">
    ...
    <!-- Modal -->
    @if ($open)
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center" x-show="open" x-transition>
            <div class="bg-white p-6 rounded-lg w-96">
                ...
                <form wire:submit.prevent="{{ $ingresoId ? 'update' : 'store' }}">
                    ...
                    <!-- Mostrar campo de Gmail solo al editar -->
                    @if ($ingresoId)
                        <div class="mb-4">
                    ...
                    <div class="mb-4 opacity-0">
                        ...
                        <select id="estado" wire:model="estado" class="mt-1 p-2 w-full border border-gray-300 rounded-md none" disabled>
