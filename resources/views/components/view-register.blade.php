<div class="mx-auto">
    ...
    <div class="grid grid-cols-2 gap-x-10">
        ...
        <div>
            ...
            <div class="flex flex-col text-center w-96 mx-auto">
                <h2 class="font-bold text-xl">Registrar Nuevo Empleado</h2>
                <p class="text-slate-500 text-sm">"Introduce los datos necesarios para añadir un nuevo empleado a la empresa y facilitar su acceso al sistema."</p>
            </div>
        </div>
    </div>
