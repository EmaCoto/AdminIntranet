<div class="mx-auto">
    <h1 class="font-extrabold text-center text-slate-700 uppercase text-3xl">¿Quieres hacer un nuevo registro?</h1>
    ...
    <div class="grid grid-cols-2 gap-x-10">
        {{-- <div>
            <div class="relative duration-300 m-10 mx-auto group border-sky-900 border-4  overflow-hidden rounded-2xl h-56 w-80 bg-white p-5 flex flex-col items-start gap-3 shadow-xl hover:shadow-gray-700 hover:-translate-y-1">
            ...
            <div class="flex flex-col text-center w-96 mx-auto">
                <h2 class="font-bold text-xl">Agregar Administrador</h2>
                <p class="text-slate-500 text-sm">"Añade un perfil de administrador. Completa los datos necesarios para activar el acceso y permisos en el sistema."</p>
            </div>
        </div> --}}
        <div>
            <div class="relative duration-300 m-10 mx-auto group border-sky-900 border-4  overflow-hidden rounded-2xl h-56 w-80 bg-white p-5 flex flex-col items-start gap-3 shadow-xl hover:shadow-gray-700 hover:-translate-y-1">
                <div class="text-[#B33031] w-full text-right">
                    <p class="text-2xl font-bold">Colaborador</p>
                </div>
            ...
            <div class="flex flex-col text-center w-96 mx-auto">
                <h2 class="font-bold text-xl">Registrar Nuevo Colaborador</h2>
                <p class="text-slate-500 text-sm">"Introduce los datos necesarios para añadir un nuevo colaborador a la empresa y facilitar su acceso al sistema."</p>
            </div>
        </div>
    </div>
