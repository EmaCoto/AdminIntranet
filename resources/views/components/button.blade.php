<button type="submit" class="relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-[#11163D] rounded-md group mx-3">
    ...
    <span class="relative text-base font-semibold">{{ $slot }}</span>
</button>
