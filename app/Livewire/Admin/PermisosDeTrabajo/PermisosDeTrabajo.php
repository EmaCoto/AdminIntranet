...
namespace App\Livewire\Admin\PermisosDeTrabajo;

use Illuminate\Support\Facades\DB;
use Livewire\WithPagination;
use Livewire\Component;

class PermisosDeTrabajo extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $users = DB::connection('wordpress')
            ...
            ->having('job_title', 'LIKE', '%permisos de trabajo%')
            // ->orderBy('ID', 'desc')
            ->paginate(10);
        return view('livewire.admin.permisos-de-trabajo.permisos-de-trabajo', compact('users'));
    }
}
