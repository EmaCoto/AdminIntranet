...
namespace App\Livewire\Admin\Servihuellas;
...
class Servihuellas extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $users = DB::connection('wordpress')
            ...
            ->having('job_title', 'LIKE', '%Servi huellas%')
            // ->orderBy('ID', 'desc')
            ->paginate(10);
        return view('livewire.admin.servihuellas.servihuellas', compact('users'));
    }
}
