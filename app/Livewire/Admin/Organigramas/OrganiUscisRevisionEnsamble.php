...
class OrganiUscisRevisionEnsamble extends Component
{
    ...
    public function render()
    {
        ...
        $profileOrder = [
            'deputy-director-uscis-revision-and-assembly',
            'uscis-revision-and-assembly'
        ];
        ...
        $users = DB::connection('wordpress')
            ...
            ->whereRaw("(SELECT value FROM dxv_bp_xprofile_data WHERE user_id = dxv_users.ID AND field_id = 50 LIMIT 1) IN ('Revisión y Ensamble USCIS')")
            ->get()
        ...
        return view('livewire.admin.organigramas.organi-uscis-revision-ensamble', compact('users', 'profileTypes'));
    }
}
