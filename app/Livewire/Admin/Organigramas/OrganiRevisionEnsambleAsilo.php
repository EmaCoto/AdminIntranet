...
class OrganiRevisionEnsambleAsilo extends Component
{
    ...
    public function render()
    {
        ...
        $profileOrder = [
            'depury-director-revision-and-assembly',
        ...
        $users = DB::connection('wordpress')
            ...
            ->whereRaw("(SELECT value FROM dxv_bp_xprofile_data WHERE user_id = dxv_users.ID AND field_id = 50 LIMIT 1) IN ('Revisión y Ensamble de Asilo')")
            ->get()
        ...
        return view('livewire.admin.organigramas.organi-revision-ensamble-asilo', compact('users', 'profileTypes'));
    }
}
