...
class OrganiVentasIms extends Component
{
    ...
    public function render()
    {
        ...
        $users = DB::connection('wordpress')
            ...
            ->whereRaw("(SELECT value FROM dxv_bp_xprofile_data WHERE user_id = dxv_users.ID AND field_id = 50 LIMIT 1) IN ('Ventas IMS')")
            ->get()
        ...
        return view('livewire.admin.organigramas.organi-ventas-ims', compact('users', 'profileTypes'));
    }
}
