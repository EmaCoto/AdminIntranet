...
namespace App\Livewire\Admin\ManejoDeDocumentos;

use Illuminate\Support\Facades\DB;
use Livewire\WithPagination;
use Livewire\Component;

class ManejoDeDocumentos extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $users = DB::connection('wordpress')
            ...
            ->having('job_title', 'LIKE', '%manejo de documentos%')
            // ->orderBy('ID', 'desc')
            ->paginate(10);
        return view('livewire.admin.manejo-de-documentos.manejo-de-documentos', compact('users'));
    }
}
