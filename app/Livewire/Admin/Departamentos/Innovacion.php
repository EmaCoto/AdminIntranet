...
class Innovacion extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $users = DB::connection('wordpress')
            ...
            ->having('job_title', 'LIKE', 'Innovación y ciencia de datos')
            // ->orderBy('ID', 'desc')
            ->paginate(10);
        return view('livewire.admin.departamentos.innovacion', compact('users'));
    }
}
