...
class VentasPermisosTrabajo extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $users = DB::connection('wordpress')
            ...
            ->having('job_title', 'LIKE', 'Ventas de Permisos de Trabajo')
            // ->orderBy('ID', 'desc')
            ->paginate(10);
    
        return view('livewire.admin.departamentos.ventas-permisos-trabajo', compact('users'));
    }
}
