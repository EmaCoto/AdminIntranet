...
class RevisionEnsambleAsilo extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $users = DB::connection('wordpress')
            ...
            ->having('job_title', 'LIKE', 'Revisión y Ensamble de Asilo')
            // ->orderBy('ID', 'desc')
            ->paginate(10);
    
        return view('livewire.admin.departamentos.revision-ensamble-asilo', compact('users'));
    }
}
