...
class SeguimientoUscis extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $users = DB::connection('wordpress')
            ...
            ->having('job_title', 'LIKE', 'Seguimiento de USCIS')
            // ->orderBy('ID', 'desc')
            ->paginate(10);
    
        return view('livewire.admin.departamentos.seguimiento-uscis', compact('users'));
    }
}
